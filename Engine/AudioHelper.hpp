...
public:
	...
	static bool isMainMenuMusicPlaying;
	...
	static bool GetMainMenuMusicPlaying() {return isMainMenuMusicPlaying;}
	static void SetMainMenuMusicPlaying(const bool newState) {isMainMenuMusicPlaying = newState;}
