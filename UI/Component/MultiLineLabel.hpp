#ifndef MULTILINE_LABEL_HPP
#define MULTILINE_LABEL_HPP
...
namespace Engine {
	...
	/// </summary>
	class MultiLineLabel : public IObject {
	protected:
	...
	public:
		...
		explicit MultiLineLabel(const std::string& text, const std::string& font, int fontSize, float x, float y, unsigned char r = 0, unsigned char g = 0, unsigned char b = 0, unsigned char a = 255, float anchorX = 0, float anchorY = 0);
		/// <summary>
        ...
        int GetTextWidth(const std::string& line) const;
		/// <summary>
		/// Return text height.
		/// </summary>
