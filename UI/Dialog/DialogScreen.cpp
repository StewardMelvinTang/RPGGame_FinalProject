...
namespace Engine {
	DialogScreen::DialogScreen(std::string dialogText, std::string charName, float duration, IObject * playerSprite) : Image(dialogBGpath, 0, 0, 0, 0, 0, 0, true), playerCharSprite(playerSprite) {
        ...
        TXT_Dialog = new Engine::Label(displayedText, "pixel-font.ttf", 30, 190, 565, 255, 255, 255, 255);
